...
; - Įkopijuoja failą RenameFromTender.ps1 ir RunRenameHidden.vbs į %LocalAppData%\TenderRenamer
; - Sukuria HKCU kontekstinį meniu, pririšta prie tender.xml failo
; - Administratoriaus teisių nereikalauja 

#define AppName        "Pasiūlymo failų pervardintojas"
#define AppVersion     "1.0.0"
#define Publisher      "Gediminas Golcevas"
#define InstallDirName "{localappdata}\TenderRenamer"
...
[Files]
; Patalpinkite failus RenameFromTender.ps1 ir RunRenameHidden.vbs prie šio .iss failo prieš kompiliuodami
Source: "RenameFromTender.ps1"; DestDir: "{app}"; Flags: ignoreversion
Source: "RunRenameHidden.vbs"; DestDir: "{app}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Classes\SystemFileAssociations\.xml\shell\Pervardintojas"; \
    ValueType: string; ValueName: "Icon"; ValueData: "{sys}\wscript.exe"
...
Root: HKCU; Subkey: "Software\Classes\SystemFileAssociations\.xml\shell\Pervardintojas\command"; \
    ...
    ValueData: """{sys}\wscript.exe"" //B //Nologo ""{app}\RunRenameHidden.vbs"" ""%1"""; \
